    ...
    <div className="rounded-lg h-[436px] flex flex-col bg-gray-800 overflow-hidden border-2 border-gray-800 hover:border-emerald-500 opacity-70 hover:opacity-100 transition-all group">
      ...
      <div className="flex-1 flex flex-col p-8">
        ...
        <p className="mt-2 text-gray-400 line-clamp-4">
          BookWise is a book review platform developed during Rocketseat's
          Ignite bootcamp. Starting with just a Figma design, we needed to
          develop this complete Full Stack application using Next.js.
        </p>
