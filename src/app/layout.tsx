...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Home | Marcelo Pereira',
    template: '%s | Marcelo Pereira',
  },
  ...
  openGraph: {
    ...
    description:
      'Welcome to my portfolio! Here you can explore my selected projects, which showcase my skills in front-end development and my dedication to delivering high-quality web applications.',
    url: 'https://marcelopereira.vercel.app',
    images: [
      {
        url: 'https://marcelopereira.vercel.app/icon-384x384.png',
        width: 384,
        height: 384,
      },
      {
        url: 'https://marcelopereira.vercel.app/icon-512x512.png',
        width: 512,
        height: 512,
      },
    ],
